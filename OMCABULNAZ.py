...
class instagram:
	...
	def mentod(self):
	        ...
	        pornhub.append(Panel(f"{P2}lisensi : {H2}{key}Sampek kiamat\n{P2}join    : {H2}{tanggal1} {bulan1} {tahun1}\n{P2}expired : {H2}{tanggal} {bulan} {tahun}\n{P2}bayar : {H2} Yah Jelas Tai",title=f"{M2}• {K2}• {H2}•{P2} DATA BAYAR {H2}• {K2}• {M2}•",width=39,padding=(0,2),style=f"#FFFFFF"))
	...
	def ua_ig(self):
	    rr = random.randint
	    return (f"Mozilla/5.0 (Linux; Android {str(rr(7,12))}.{str(rr(7,12))}; Redmi Note {str(rr(7,12))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(80,105))}.0.{str(rr(1111,4444))}.{str(rr(111,400))} Mobile Safari/537.36 Instagram 37.0.0.9.96 (iPhone9,4; iOS 10_3_3; ru_RU; ru-RU; scale=2.61; gamut=wide; 1080x1920)"
					...
					for z in range (9999):
						...
						try:
							for i in x_jason['users']:
								...
								following.append(username)
							wr = random.choice(['\x1b[1;91m', '\x1b[1;92m', '\x1b[1;93m', '\x1b[1;94m', '\x1b[1;95m', '\x1b[1;96m', '\x1b[1;97m', '\x1b[0m'])
							sys.stdout.write(f"\r{P}[{B}*{P}] Sedang Mengumpulkan {wr}{len(internal)} {P}Pepek...{P}")
							sys.stdout.flush()
							time.sleep(0.0002)
							try:
								maxid=x_jason['next_max_id']
					...
					for z in range (9999):
						...
						try:
							for i in x_jason['users']:
								...
								following.append(username)
							wr = random.choice(['\x1b[1;91m', '\x1b[1;92m', '\x1b[1;93m', '\x1b[1;94m', '\x1b[1;95m', '\x1b[1;96m', '\x1b[1;97m', '\x1b[0m'])
							sys.stdout.write(f"\r{P}[{B}*{P}] Sedang Mengumpulkan {wr}{len(internal)} {P}Pepek...")
							sys.stdout.flush()
							time.sleep(0.0002)
							try:
								maxid=x_jason['next_max_id']
	...
	def methodku(self):
		urut = []
		urut.append(Panel(f"API NERAKA{H2}Recommended{P2}",title=f"{R2}01{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
		urut.append(Panel(f"PAJAK{H2} Slow{P2}",title=f"{R2}02{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
		urut.append(Panel(f"API V2{H2}Past",title=f"{R2}03{P2}",width=27,padding=(0,6),style=f"#FFFFFF"))
		self.tol.print(Columns(urut))
